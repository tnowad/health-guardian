...
public class SeedServiceImpl implements SeedService {
  ...
  public void mock() {
    ...
    // String userType = faker.options().option("Admin", "Moderator", "Medical",
    // "Non-medical");
    //
    ...
    // User user =
    // User.builder()
    // .type(UserType.values()[faker.number().numberBetween(0,
    ...
    // .dob(
    // Date.valueOf(
    // LocalDate.now().minusYears(faker.number().numberBetween(1,
    // 100))))
    // .gender(faker.options().option("Male", "Female"))
    // .status(
    // MedicalStatus.values()[
    // faker.number().numberBetween(0,
    // MedicalStatus.values().length)])
    // .guardian(guardian)
    // .build());
    // }
    // });
    ...
    // .dosageForm(faker.options().option("Tablet", "Capsule", "Injection",
    // "Syrup"))
    ...
    // for (int i = 0;
    // i < 10;
    // i++) { // Assuming each patient might report several side effects
    // per
    // // prescription
    // SideEffect sideEffect =
    ...
    // Date.valueOf(
    // LocalDate.now()
    // .minusDays(faker.number().numberBetween(1,
    // 365))))
    // .severity(
    // SideEffectSeverity.values()[
    // faker
    ...
    // .outcome(
    // faker.options().option("Resolved", "Ongoing",
    // "Worsened"))
    // .build();
    ...
    // for (int i = 0; i < 100; i++) {
    // Patient headPatient =
    // patientRepository.findAll().get(faker.number().numberBetween(0,
    // 99));
    ...
    // userMedicalStaffRepository.findAll().get(faker.number().numberBetween(0,
    // 99));
    ...
    // .consentDate(
    // Date.valueOf(
    // LocalDate.now().minusDays(faker.number().numberBetween(1,
    // 365))))
    // .status(
    // ConsentStatus.values()[
    // faker.number().numberBetween(0,
    // ConsentStatus.values().length)])
    // .build();
