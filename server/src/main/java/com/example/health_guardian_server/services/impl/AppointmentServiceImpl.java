...
public class AppointmentServiceImpl implements AppointmentService {
  ...
  public Appointment createAppointment(Appointment appointment) {
    ...
    sendNotification(
        ...
        "Appointment with ID: " + savedAppointment.getId() + " has been created.");
  ...
  public Appointment updateAppointment(Appointment appointment) {
    ...
    sendNotification(
        "Appointment Updated",
        "Appointment with ID: " + updatedAppointment.getId() + " has been updated.");
  ...
  public void deleteAppointment(String appointmentId) {
    ...
    sendNotification(
        "Appointment Deleted", "Appointment with ID: " + appointmentId + " has been deleted.");
  }
